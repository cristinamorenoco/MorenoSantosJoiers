...
data = [
    ...
    ("Contacto", "Email", "Dirección", "[email protected]", "[email real de Moreno Santos Joiers]", "Actualizar con el email real de la empresa."),
    ("Contacto", "Teléfono", "Número", "+34 932 000 000", "[Teléfono real de Moreno Santos Joiers]", "Actualizar con el teléfono real de la empresa."),
    ("Contacto", "WhatsApp", "Número", "+34 600 000 000", "[WhatsApp real de Moreno Santos Joiers]", "Actualizar con el WhatsApp real si disponéis de él."),
    ...
    ("Contacto", "Ubicación", "Dirección", "Carrer del Bisbe, 12", "[Dirección real de Moreno Santos Joiers]", "Actualizar con dirección real."),
    ("Contacto", "Ubicación", "Metro", "Barrio Gótico · Metro Jaume I (L4)", "[Indicaciones de transporte real]", "Actualizar con indicaciones reales."),
